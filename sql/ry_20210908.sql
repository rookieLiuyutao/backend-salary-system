...
values (100, 0, '0', '太原理工大学', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '太原理工大学', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '软件系', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '数学系', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (104, 101, '0,100,101', '系党委', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (105, 101, '0,100,101', '系办公室', 3, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (106, 101, '0,100,101', '教务部', 4, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (107, 101, '0,100,101', '组织部', 5, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (108, 102, '0,100,102', '宣传部', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (109, 102, '0,100,102', '统战部', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
values (1, 103, '刘宇韬', '大菜狗', '00', '958532148@qq.com', '13233059962', '1', '',
        ...
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, '王誉', 'wang', '00', 'ry@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
values (1, 'ceo', '董事长', 30000.00, 1, '0', 'admin', sysdate(), '', null, '');
insert into sys_post
values (2, 'se', '项目经理', 25000.00, 2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post
values (3, 'hr', '人力资源', 15000.00, 3, '0', 'admin', sysdate(), '', null, '');
insert into sys_post
values (4, 'user', '普通员工', 10000.00, 4, '0', 'admin', sysdate(), '', null, '');
...
-- 岗位管理按钮
insert into sys_menu
values ('1021', '岗位查询', '104', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:post:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1022', '岗位新增', '104', '2', '', '', '', 1, 0, 'F', '0', '0', 'system:post:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1023', '岗位修改', '104', '3', '', '', '', 1, 0, 'F', '0', '0', 'system:post:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
...
values('出勤', '1', '1', 'attendance', 'system/attendance/index', 1, 0, 'C', '0', '0', 'system:attendance:list', '#', 'admin', sysdate(), '', null, '出勤菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('出勤查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:attendance:query',        '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('出勤新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'system:attendance:add',          '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('出勤修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'system:attendance:edit',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('出勤删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'system:attendance:remove',       '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('出勤导出', @parentId, '5',  '#', '', 1, 0, 'F', '0', '0', 'system:attendance:export',       '#', 'admin', sysdate(), '', null, '');



-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税', '1', '1', 'bank', 'system/bank/index', 1, 0, 'C', '0', '0', 'system:bank:list', '#', 'admin', sysdate(), '', null, '银行扣税菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:bank:query',        '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'system:bank:add',          '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'system:bank:edit',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'system:bank:remove',       '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('银行扣税导出', @parentId, '5',  '#', '', 1, 0, 'F', '0', '0', 'system:bank:export',       '#', 'admin', sysdate(), '', null, '');



-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('工资', '3', '1', 'salary', 'system/salary/index', 1, 0, 'C', '0', '0', 'system:salary:list', '#', 'admin', sysdate(), '', null, '工资菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('工资查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:salary:query',        '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('工资新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'system:salary:add',          '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('工资修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'system:salary:edit',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('工资删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'system:salary:remove',       '#', 'admin', sysdate(), '', null, '');
...
# (
#     salary_id    bigint auto_increment comment '工资记录'
#         primary key,
#     user_id      bigint                    null comment '用户id' ,
#     foreign key (user_id) references sys_user(user_id),
#     user_name    varchar(30)              not null comment '用户账号',
#     foreign key (user_name) references sys_user(user_name),
#     before_tax   double                   null comment '基本工资',
#     reward       double                   null comment '各种奖金',
#     tax          double                   null comment '扣税',
#     final_salary double                   null comment '到手工资',
#     salary_time  datetime                 null comment '开资时间',
#     bank_card_id bigint                   null comment '工资卡号' unique
#
#
# )engine=innodb auto_increment=1 comment = '用户工资表';
...
values (1, 1, '软件学院', 181301, date_format(now(),'%Y-%m-%d'), 0, 0, 0, 0);
...
(
    ...
    after_tax   double default (before_tax - deduction) comment '税后工资'
) engine = innodb
  auto_increment = 200 comment = '银行扣税表';
...
(
  ...
  auto_increment = 200 comment = '出勤表';

insert into sys_attendance
values (180001, 1, date_format(now(),'%Y-%m-%d'));